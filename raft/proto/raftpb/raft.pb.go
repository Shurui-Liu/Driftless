...
type RequestVoteRequest struct {
	...
	CandidateId   string                 `protobuf:"bytes,2,opt,name=candidate_id,json=candidateId,proto3" json:"candidate_id,omitempty"`       // so peers record who they voted for
...
type RequestVoteResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Term          int64                  `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"` // peer's current term (candidate updates if stale)
...
type LogEntry struct {
	...
	Command       []byte                 `protobuf:"bytes,3,opt,name=command,proto3" json:"command,omitempty"` // encoded task state transition
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AppendEntriesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Term          int64                  `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"` // follower's term (leader steps down if stale)
...
const file_proto_raft_proto_rawDesc = "" +
	...
	"\x0fRaftCoordinator\x12B\n" +
	"\vRequestVote\x12\x18.raft.RequestVoteRequest\x1a\x19.raft.RequestVoteResponse\x12H\n" +
	"\rAppendEntries\x12\x1a.raft.AppendEntriesRequest\x1a\x1b.raft.AppendEntriesResponseB3Z1github.com/shurui-liu/driftless/raft/proto/raftpbb\x06proto3"
...
var file_proto_raft_proto_depIdxs = []int32{
	...
	0, // 1: raft.RaftCoordinator.RequestVote:input_type -> raft.RequestVoteRequest
	3, // 2: raft.RaftCoordinator.AppendEntries:input_type -> raft.AppendEntriesRequest
	1, // 3: raft.RaftCoordinator.RequestVote:output_type -> raft.RequestVoteResponse
	4, // 4: raft.RaftCoordinator.AppendEntries:output_type -> raft.AppendEntriesResponse
